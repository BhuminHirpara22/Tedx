    ...
    <div className="Committees">
      ...
      <section id="committees" className="committees-section">
        ...
        <p className="description">
          <span style={{ fontWeight: "900" }}>"Ideas Worth Sharing: "</span>We
          believe that for humankind to truly progress and achieve our
          potential, the exchange of ideas between people is essential. TED
          helps us list the problems people face even in the remotest corners of
          the world. This promotes discussions to come up with solutions and
          ideas from pioneers and amateurs.
        </p>
